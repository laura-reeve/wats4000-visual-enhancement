<template>
  <div>
    <div class="messages">
      <!-- Message container child component -->
    ...
    <div class="word-list-container">
      <h2>Word List</h2>
      <ul class="word-list">
        <!-- Word List add/remove animation -->
        <transition-group name="bounceRight" tag="div" appear>
  ...
  methods: {
    addWord: function (word) {
      if (this.wordList.indexOf(word) === -1) {
        ...
        this.messages.push ({
          type: 'success',
          text: `Added ${word} to Word List.`
          });
      } else {
        this.messages.push ({
          type: 'info',
          text: `${word} is already on Word List.`
          });
      }
    },
    removeWord: function (word) {
      ...
      this.messages.push ({
        type: 'success',
        text: `${word} was removed from Word List.`
      });
    },
    findWords: function() {
